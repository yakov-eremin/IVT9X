...
namespace KProject
{
    public class SomeClass
    {
        ...
        public SomeClass(double var1, int var2)
        {
            Var1 = var1;
            Var2 = var2;
        }

        public SomeClass Best(SomeClass some)
        {
        ...
        //Работа с числами
        public static int SingOfNumber(string number)
        {
        ...
        //Работа с массивами
        public static void BubbleSort(double[] array, int mode)
        {
            if (mode == 1)
            {
