      ...
      <View style={[
        ...
        {!this.state.searchActive ?
          ...
          <View style={styles.headerCtrl}>
            ...
            <View style={styles.rightSide}>
              {this.props.searchHeader ? 
                <TouchableOpacity style={styles.button} onPress={()=> this.setState({searchActive:true})}>
              ...
              {this.props.pressBtnRight ? 
                <TouchableOpacity onPress={this.props.pressBtnRight} style={styles.button}>
                  <Text style={styles.buttonText}>{this.props.btnBtnRightText ? this.props.btnBtnRightText : 'Сохранить'  }</Text>
                </TouchableOpacity>
              : null}
            </View>
          ...
          <View style={styles.headerSearch}>
            ...
            />
            <TouchableOpacity style={styles.button} onPress={()=> this.setState({searchActive:false})}>
